...
| [hslatman/caddy-crowdsec-bouncer/appsec](https://github.com/hslatman/caddy-crowdsec-bouncer/tree/main/appsec)  | Security                 | Appsec HTTP handler for Crowdsec Appsec component, requires Crowdsec              |
